...
import { OVERLAY_TONE_CLASS, type ThreadOverlayTone } from "@/lib/thread-overlay";
...
interface SlimRowProps {
  ...
  /** The status tint the row carries: "done" for settled, else none. */
  statusOverlay: ThreadOverlayTone;
  wakeAt: number | null;
  now: number;
...
function slimRowPresentation({
  ...
  return {
    rowClassName: cn(
      ...
      OVERLAY_TONE_CLASS[statusOverlay],
